...
Player.prototype.update = function() {
	...
	if (player.y < 20) {
		...
		//**********  Collision *****score *************
	} else if (amyXPos < playerXMax && amyXMax > playerXPos && amyYPos < playerYMax && amyYMax > playerYPos) {
		scoreBump = -1;
	...
	} else if (benXPos < playerXMax && benXMax > playerXPos && benYPos < playerYMax && benYMax > playerYPos) {
		scoreBump = -1;
	...
	} else if (joeXPos < playerXMax && joeXMax > playerXPos && joeYPos < playerYMax && joeYMax > playerYPos) {
		scoreBump = -1;
		...
		//    ************Gem Collected*** score**********
	} else if (gemGreenXPos < playerXMax && gemGreenXMax > playerXPos && gemGreenYPos < playerYMax && gemGreenYMax > playerYPos) {
		scoreBump = 2;
	...
	} else if (gemOrangeXPos < playerXMax && gemOrangeXMax > playerXPos && gemOrangeYPos < playerYMax && gemOrangeYMax > playerYPos) {
		scoreBump = 2;
	...
	} else if (gemBlueXPos < playerXMax && gemBlueXMax > playerXPos && gemBlueYPos < playerYMax && gemBlueYMax > playerYPos) {
		scoreBump = 2;
